...
const BIBLE_VERSES = [
  ...
  },
  {
    ...
    chapter: 6,
    verse: 14,
    text: '너희가 사람의 과실을 용서하면 너희 하늘 아버지도 너희를 용서하시려니와',
  },
  {
    book: '에베소서',
    chapter: 4,
  ...
  },
  {
    ...
    chapter: 29,
    verse: 11,
    text: '여호와의 말씀이니라 너희를 향한 나의 생각은 내가 아나니 재앙이 아니라 곧 평안이요 너희에게 미래와 소망을 주는 것이니라',
  },
  {
    book: '빌립보서',
    chapter: 4,
  ...
  // 가족과 관계
  {
    ...
    chapter: 5,
    verse: 25,
    text: '남편들아 아내 사랑하기를 그리스도께서 교회를 사랑하시고 위하여 자신을 주심 같이 하라',
  },
  {
    book: '에베소서',
    chapter: 6,
  ...
  },
  {
    ...
    chapter: 16,
    verse: 3,
    text: '너의 행사를 여호와께 맡기라 그리하면 너의 경영하는 것이 이루어지리라',
  },
  {
    book: '전도서',
    chapter: 9,
    verse: 10,
    text: '무엇이든지 네 손이 할 일을 힘을 다하여 하라 네가 가는 음부에는 일도 없고 계획도 없고 지식도 없고 지혜도 없음이니라',
  },
  ...
  },
  {
    ...
    chapter: 22,
    verse: 7,
    text: '부자는 가난한 자를 주관하고 빚진 자는 빌려 준 자의 종이 되느니라',
  },
  {
    book: '디모데전서',
    chapter: 6,
    verse: 10,
    text: '돈을 사랑함이 일만 악의 뿌리가 되나니 이것을 탐내는 자들은 미혹을 받아 믿음에서 떠나 많은 근심으로써 자기를 찔렀도다',
  },
  ...
  },
  {
    ...
    chapter: 53,
    verse: 5,
    text: '그가 찔림은 우리의 허물 때문이요 그가 상함은 우리의 죄악 때문이라 그가 징계를 받으므로 우리가 평화를 누리고 그가 채찍에 맞으므로 우리가 나음을 받았도다',
  },
  ...
  },
  {
    ...
    chapter: 6,
    verse: 34,
    text: '그러므로 내일 일을 위하여 염려하지 말라 내일 일은 내일이 염려할 것이요 한 날의 괴로움은 그 날에 족하니라',
  },
  {
    book: '빌립보서',
    chapter: 4,
    verse: 6,
    text: '아무 것도 염려하지 말고 다만 모든 일에 기도와 간구로, 그리고 감사함으로 너희 구할 것을 하나님께 아뢰라',
  },
  ...
  },
  {
    ...
    chapter: 100,
    verse: 4,
    text: '감사함으로 그 문에 들어가며 찬송함으로 그 궁정에 들어가서 그를 송축하며 그의 이름을 찬송할지어다',
  },
  {
    book: '시편',
    chapter: 34,
    verse: 1,
    text: '내가 여호와를 항상 송축함이여 그를 송축함이 내 입에 계속하리로다',
  },
];

async function initBibleDataOnly() {
  try {
    ...
    console.log(
      '참고: 임베딩을 생성하려면 OPENAI_API_KEY를 설정하고 npm run db:init-bible을 실행하세요.',
    );
  } catch (error) {
